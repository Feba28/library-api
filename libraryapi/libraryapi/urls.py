...
router.register('user',views.userviewset),#any name in user type this name in link portion


urlpatterns = [
    path('admin/', admin.site.urls),
    # path('',views.booklist.as_view(),name='booklist'),
    # path('bookdetails/<int:pk>',views.bookdetails.as_view(),name='bookdetails'),
